        ...
        <div className="bg-white rounded-2xl shadow-xl ring-1 ring-zinc-200 p-8 md:p-10">
          ...
          <div className="mt-10">
            ...
            <ul className="list-disc list-inside text-zinc-700 space-y-2">
              <li><span className="text-zinc-900 font-medium">Education:</span> North Central Texas College — Associate of Computer Science (Honors Program)</li>
              <li><span className="text-zinc-900 font-medium">Internship:</span> Jenzabar @ NCTC (Nov 2023 – May 2025) — IT ticket support, student data systems, exposure to SQL/Java/C++ workflows</li>
              <li><span className="text-zinc-900 font-medium">Projects:</span> Pokémon Search; Weather Dashboard (Node/SQLite/Chart.js); Smart Productivity Assistant (AWS serverless)</li>
              <li><span className="text-zinc-900 font-medium">Certificates:</span> FreeCodeCamp — Responsive Web Design; JavaScript Algorithms &amp; Data Structures</li>
            </ul>
          </div>
        </div>
      </div>
