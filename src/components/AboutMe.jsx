      ...
      <div className="max-w-5xl mx-auto">
        <div className={isPaper
          ...
          <p className={isPaper ? "text-lg leading-relaxed text-zinc-700" : "text-lg leading-relaxed text-zinc-300"}>
            I’m <span className="font-semibold">Desmond Harry Adebowale</span>, a Computer Science graduate passionate about
            building applications that make life simpler and more efficient. I work with Java, Python, JavaScript,
            <span className={isPaper ? "font-medium text-zinc-900" : "font-medium text-white"}> React</span>, and SQL, and I’ve shipped cloud projects using
          ...
          <div className="mt-4">
            <p className={isPaper ? "text-zinc-700" : "text-zinc-300"}>
              ...
              Computer Science internship at <span className={isPaper ? "font-medium text-zinc-900" : "font-medium text-white"}>Jenzabar @ NCTC</span> (Nov 2023–May 2025),
              I collaborated with staff on IT support tickets and student data systems, and learned SQL/Java/C++ workflows.
              That experience sharpened my communication, debugging, and delivery habits on real stakeholder needs.
            </p>
          </div>
